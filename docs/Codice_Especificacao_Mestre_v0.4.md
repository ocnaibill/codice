...
| DEC-086 | A retomada equivalente (RF-042) usa heurísticas sobre o texto já indexado (sequências de palavras, nomes e números, título ou número do capítulo, contagem de capítulos), sem modelo; a sugestão é um salto único, nunca sincronização contínua, e o aceite é só histórico | Um candidato só aponta para conteúdo realmente encontrado no destino; sem evidência, nenhuma sugestão, e duas igualmente prováveis são ambíguas para a pessoa escolher, nunca um palpite. Depois do salto cada arquivo segue com o seu próprio progresso (DEC-030); a interface mostra a versão que conta (DEC-079). **Régua pública repetível (#32, 25/09/2026):** três EPUBs de domínio público de *Da Terra à Lua*, com verdade por números raros únicos no mesmo capítulo e todos os números mascarados antes da busca. O perfil determinístico ofereceu 100/106 posições entre idiomas, com 92,0% de precisão e 86,8% de acerto efetivo a até um trecho; no mesmo idioma, 134/134. Por método/confiança: texto-alta 134/134, âncoras-alta 7/7, âncoras-média 24/26, âncoras-baixa 6/10 e estrutura-média 55/57. Em 60 origens de dois livros diferentes de Sherlock Holmes, houve 5 ofertas indevidas; essa régua negativa é um teste de estresse, pois a retomada só compara arquivos já pertencentes à mesma obra |
...
| DEC-089 | (confirmada pelo mantenedor em 21 e ampliada em 22/09/2026) O reforço semântico da retomada equivalente é uma **capacidade local opcional**, desligada por padrão na interface; o owner escolhe o perfil leve e5-small para línguas de alfabeto latino ou o LaBSE para cobertura multilíngue ampla | Na pilha completa, o worker de embeddings fica separado e ocioso até o owner ativar o recurso; na primeira ativação baixa apenas o modelo escolhido para cache persistente e a tela expõe disponibilidade, preparação, pronto ou erro. Trocar de perfil conserva os caches e recalcula os vetores derivados com o modelo novo. Desativar impede calcular e usar embeddings sem apagar cache ou vetores. O worker não bloqueia ingestão nem leitura e nenhum texto é enviado a terceiros. Cada vetor registra provedor, modelo, revisão, dimensão, normalização e versão do pré-processamento e só é comparado com vetores compatíveis. A semântica entra depois das evidências lexical e por âncoras, exige limiar mínimo e vizinho mais próximo recíproco. O e5-small custa cerca de 471 MB e mediu ~35 trechos/s no M4; o LaBSE custa cerca de 1,9 GB e ~14 trechos/s. **Reensaio com a extração atual e a regra recíproca (22/09):** em Verne ambos acharam 94,4% antes da abstinência e fizeram 80,6–81,9% efetivos; em Duna EN↔PT o e5-small fez 64,6% efetivos contra 70,0% do LaBSE, e em PT-PT↔PT-BR fez 70,0% contra 66,7%; com árabe, porém, o e5-small ficou em 28,9–37,5% e o LaBSE em 65,0–65,8%. Quando ofereceram, a precisão a até um trecho ficou entre 84,6% e 100%, normalmente acima de 93%. **Na régua pública estruturada da #32 (25/09),** ambos elevaram a cobertura entre idiomas de 94,3% para 96,2%, mas mantiveram o acerto efetivo em 86,8% e reduziram a precisão para 90,2%; nos livros irmãos negativos, as ofertas indevidas subiram de 5/60 para 17/60 (e5) e 15/60 (LaBSE). Portanto, semântica continua sendo reforço para a ausência de estrutura e não é evidência suficiente para sugerir que dois arquivos sejam a mesma obra. O perfil amplo continua recomendado quando possa haver alfabetos distantes; o leve é uma escolha explícita para máquinas e acervos latinos mais modestos. Vetores são derivados e ficam fora do backup |
...
| QA-028 | Como validar retomada equivalente entre versões? | **Respondida para EPUB em português/inglês pela régua pública da #32 (DEC-086):** verdade independente, precisão, cobertura, erro, latência e memória, com pares negativos. Ainda ampliar para OCR/PDF, alfabetos distantes, edições abreviadas e capítulos reorganizados; na etapa de áudio, definir o alinhamento temporal |
