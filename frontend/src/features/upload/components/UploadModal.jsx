          ...
          <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-zinc-700 border-dashed rounded-lg cursor-pointer bg-zinc-950/50 hover:bg-zinc-800 hover:border-zinc-500 transition-colors">
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              ...
              <p className="text-sm text-zinc-400">
                <span className="font-semibold text-blue-400">Click to select</span> a file (PDF, EPUB, CBZ, CBR, TXT, MOBI, audiobook)
              </p>
            </div>
            <input 
              type="file" 
              className="hidden" 
              accept=".pdf,.epub,.cbz,.cbr,.txt,.md,.mobi,.azw,.azw3,.mp3,.m4a,.m4b,.flac,.ogg,.wav" 
